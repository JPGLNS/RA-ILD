#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Outer-repeat-specific TRB 3-mer feature construction.
...
The ranking reproduces the original TRB step-02 rule:
...
DEFAULT_LEGACY_GROUP = "static_tcr_candidate_predictors"
