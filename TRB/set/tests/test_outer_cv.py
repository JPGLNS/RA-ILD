...
MODELS = ("M0_clinical", "M1_static_tcr")
SAMPLES = ("S1", "S2", "S3", "S4")
...
def write_complete_task(task, *, coefficient_variant: int = 0) -> None:
    ...
    coefficients = pd.DataFrame(
        [
            ...
            {"model": "M1_static_tcr", "feature_name": "__INTERCEPT__", "coefficient": -0.2, "absolute_coefficient": 0.2, "nonzero": True},
            {"model": "M1_static_tcr", "feature_name": "age", "coefficient": 0.1, "absolute_coefficient": 0.1, "nonzero": True},
            {"model": "M1_static_tcr", "feature_name": "f1", "coefficient": f1_coefficient, "absolute_coefficient": abs(f1_coefficient), "nonzero": bool(f1_coefficient)},
        ]
    )
...
class TestOuterCV(unittest.TestCase):
    ...
    def test_feature_stability_thresholds(self) -> None:
        ...
        row = result.feature_stability.set_index(["model", "feature_name"]).loc[("M1_static_tcr", "f1")]
