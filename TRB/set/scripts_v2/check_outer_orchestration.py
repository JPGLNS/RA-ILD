...
from ra_ild_trb.outer_cv import build_outer_tasks, manifest_frame, scan_outer_tasks  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Check TRB V2 outer-task orchestration and current task outputs.",
...
def main() -> int:
    ...
    try:
        ...
        v1_root = (config.repository_root / "TRB/set/train/result/05_modeling").resolve()
