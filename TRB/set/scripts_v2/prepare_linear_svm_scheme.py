#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Prepare an isolated TRB Linear SVM scheme from any completed TRB resolved config."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Prepare a TRB Linear SVM analysis scheme.",
...
def prepare(
    ...
    *,
    ...
    if str(experiment.get("receptor")) != "TRB":
        raise LinearSVMSchemeError("Base config receptor must be TRB")
    ...
    if dry_run:
        print("RA-ILD TRB Linear SVM scheme preparation")
