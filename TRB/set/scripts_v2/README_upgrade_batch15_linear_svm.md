# TRB Upgrade Batch 15 — Configurable Linear SVM Engine

## 1. Purpose

Batch 15 adds an **additive Linear SVM analysis path** to the current TRB V2
framework. It does not remove, replace, or reinterpret the historical Elastic
Net logistic-regression path.

The new path reuses the existing validated TRB layers:
...
```text
TRB/set/src/ra_ild_trb/linear_svm.py
TRB/set/src/ra_ild_trb/linear_svm_config.py
TRB/set/src/ra_ild_trb/linear_svm_nested_cv.py
TRB/set/src/ra_ild_trb/linear_svm_summary.py
TRB/set/src/ra_ild_trb/linear_svm_visualization.py
```

### Commands

```text
TRB/set/scripts_v2/prepare_linear_svm_scheme.py
TRB/set/scripts_v2/run_linear_svm_nested_cv_task.py
TRB/set/scripts_v2/run_all_linear_svm_tasks.py
TRB/set/scripts_v2/aggregate_linear_svm_results.py
TRB/set/scripts_v2/plot_linear_svm_results.py
```

### Tests and examples

```text
TRB/set/tests/test_linear_svm.py
TRB/set/tests/test_linear_svm_config.py
TRB/set/scripts_v2/test_batch15_linear_svm.py
TRB/set/configs/linear_svm/trb_linear_svm_main_example.yaml
TRB/set/configs/linear_svm/trb_linear_svm_multi_block_example.yaml
TRB/set/configs/visualization/trb_linear_svm_visualization_example.yaml
```
...
```bash
python3 TRB/set/scripts_v2/prepare_linear_svm_scheme.py \
  --scheme TRB/set/configs/linear_svm/trb_linear_svm_main_example.yaml \
...
```bash
python3 TRB/set/scripts_v2/run_all_linear_svm_tasks.py \
...
```bash
python3 TRB/set/scripts_v2/aggregate_linear_svm_results.py \
  --config TRB/set/experiments/<scheme_id>/00_config/resolved_config.yaml \
  --repository-root /data/users/chenhaisheng/RA-ILD
```
...
```bash
python3 TRB/set/scripts_v2/plot_linear_svm_results.py \
  --config TRB/set/configs/visualization/<your_svm_visualization>.yaml
```
