#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Audit effective feature inputs and model definitions without fitting models."""
...
from ra_ild_trb.specifications import select_static_tcr_features  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Audit one prepared RA-ILD TRB scheme's effective model features.",
...
def main() -> int:
    ...
    try:
        ...
        print("RA-ILD TRB feature audit: PASS")
        ...
        print(f"RA-ILD TRB feature audit: FAIL\n{exc}", file=sys.stderr)
        return 1
