#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Aggregate completed TRB Linear SVM repeated-holdout tasks."""
...
from ra_ild_trb.linear_svm_config import load_linear_svm_config  # noqa: E402
from ra_ild_trb.linear_svm_summary import write_aggregation  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Aggregate completed TRB Linear SVM repeated-holdout tasks.",
...
def main() -> int:
    ...
    try:
        ...
        print("TRB Linear SVM repeated-holdout aggregation: COMPLETE")
        print(f"Task root: {task_root}")
        print(f"Output:    {output_dir}")
        print(f"Metrics:   {paths['metrics']}")
        return 0
    except Exception as exc:
        print(f"TRB Linear SVM aggregation: FAIL\n{exc}", file=sys.stderr)
        return 1
