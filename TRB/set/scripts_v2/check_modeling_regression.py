...
from ra_ild_trb.modeling import (  # noqa: E402
    coefficient_frame,
    count_nonzero_coefficients,
    derive_seed,
    fit_elastic_net,
)
from ra_ild_trb.preprocessing import prepare_design_matrices  # noqa: E402
from ra_ild_trb.thresholds import apply_threshold, choose_threshold_youden  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compare TRB V2 modeling utilities with frozen V1 outputs.",
