...
"""Create fixed repeated nested cross-validation splits for RA/RA-ILD TRB.

Only metadata columns from the TRAIN base matrix are used. The independent test
set and TCR feature values are never read.
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Generate fixed repeated outer/inner CV assignments.",
    ...
    p.add_argument("--expected-samples", type=int, default=123)
...
def write_summary(
    ...
    lines = [
        ...
        "- No TCR feature values were used to optimize partitions.",
...
def main() -> int:
    ...
    print("=" * 80)
    print("05 Repeated Nested Cross-Validation Split Builder")
    print("=" * 80)
