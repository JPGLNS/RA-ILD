...
CONFIG_ROOT="TRB/set/configs/experiments/layer1_all128_all5alg_top10000_static_v1"
...
BATCH_ROOT="TRB/result/feature_framework/batch_logs/layer1_all5alg_top10000_static_v1"
...
echo "============================================================"
echo "Layer 1B: all-architecture algorithm expansion"
echo "Algorithms to run         : Ridge/Lasso/LinearSVM/XGBoost"
echo "Architectures / algorithm : 128"
echo "New experiments           : 512"
...
run_one() {
    ...
    then
        ...
        echo "[$(date '+%F %T')] PASS  $algorithm $name"
    else
        echo "FAIL" > "$status_file"
        echo "[$(date '+%F %T')] FAIL  $algorithm $name"
    fi
}

for algorithm in ridge lasso linear_svm xgboost
do
    echo ""
    echo "===== ALGORITHM: $algorithm ====="

    for config in "$CONFIG_ROOT/$algorithm"/S*.yaml
    do
...
echo ""
echo "============================================================"
echo "LAYER1 ALL5ALG NEW BATCH FINISHED"
echo "Finished : $(date '+%F %T')"
echo "PASS     : $PASS_COUNT / 512"
echo "FAIL     : $FAIL_COUNT / 512"
echo "============================================================"
