#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Copy fixed train/test IGH repertoire files according to split metadata.
...
Expected default source filename pattern:
    <libraryid>_IGH-without-DJ_CDR3_NT_frequency_error_correct.csv

Example:
    MGI260113R01-15_IGH-without-DJ_CDR3_NT_frequency_error_correct.csv
"""
...
DEFAULT_SUFFIX = "_IGH-without-DJ_CDR3_NT_frequency_error_correct.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Copy IGH repertoire files into fixed train/test directories according "
    ...
    parser.add_argument(
        "--source-dir",
        required=True,
        help="Directory containing all original IGH repertoire CSV files.",
    )
    parser.add_argument(
        "--train-dest",
        required=True,
...
def write_summary(
    ...
    lines = [
        "# Train/Test IGH File Copy Summary",
        "",
