#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Aggregate completed IGH Batch 15 XGBoost repeated-holdout tasks."""
...
from ra_ild_igh.xgboost_summary import discover_completed_tasks, write_aggregation  # noqa: E402


def parse_args():
    parser = argparse.ArgumentParser(
        description="Aggregate IGH XGBoost repeated-holdout results.",
...
def main() -> int:
    ...
    try:
        ...
        print("IGH XGBoost repeated-holdout aggregation: COMPLETE")
        ...
        print(f"IGH XGBoost repeated-holdout aggregation: FAIL\n{exc}", file=sys.stderr)
        return 1
