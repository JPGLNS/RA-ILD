#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run one leakage-controlled IGH Linear SVM outer task."""
...
from ra_ild_igh.linear_svm_nested_cv import (  # noqa: E402
    LinearSVMNestedCVOptions,
    run_linear_svm_outer_task,
)
from ra_ild_igh.nested_cv import validate_fixed_assignments  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one IGH Linear SVM nested-CV outer task.",
...
def main() -> int:
    ...
    try:
        ...
        print("IGH Linear SVM nested-CV task: COMPLETE")
        ...
        print(f"IGH Linear SVM nested-CV task: FAIL\n{exc}", file=sys.stderr)
        return 1
