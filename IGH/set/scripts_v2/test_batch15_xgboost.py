#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Focused post-install acceptance checks for IGH Batch 15 XGBoost."""
...
from ra_ild_igh.xgboost_model import XGBoostCandidate, fit_xgboost, xgboost_version  # noqa: E402
from ra_ild_igh.xgboost_nested_cv import XGBoostNestedCVOptions  # noqa: E402
from ra_ild_igh.xgboost_summary import XGBoostSummaryError  # noqa: E402,F401

FOCUSED_PASS = "IGH_BATCH15_XGBOOST_FOCUSED_TEST_PASS"
...
def main() -> int:
    ...
    assert pool_size == pool_size_2 == 3888
    ...
    with tempfile.TemporaryDirectory(prefix="igh_batch15_") as tmp:
    ...
    print("IGH Batch 15 XGBoost focused acceptance")
