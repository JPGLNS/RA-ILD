#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Create, inspect, and safely execute all IGH V2 outer nested-CV tasks."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Inspect or execute the full IGH V2 outer-task manifest.",
...
def main() -> int:
    ...
    try:
        ...
        print("IGH V2 outer-task status")
        ...
        print(f"IGH V2 outer-task manager: FAIL\n{exc}", file=sys.stderr)
        return 1
