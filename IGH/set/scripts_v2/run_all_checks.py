#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run the complete IGH V2 validation stack through one command."""
...
from ra_ild_igh import __version__  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run all IGH V2 configuration, unit, regression, and orchestration "
