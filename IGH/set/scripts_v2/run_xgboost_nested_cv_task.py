#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Run one leakage-controlled IGH Batch 15 XGBoost outer task."""
...
from ra_ild_igh.specifications import (  # noqa: E402
    parse_model_specifications, resolve_model_specification, select_static_igh_features,
)
from ra_ild_igh.xgboost_config import candidates_from_config, load_xgboost_config  # noqa: E402
from ra_ild_igh.xgboost_model import xgboost_version  # noqa: E402
from ra_ild_igh.xgboost_nested_cv import XGBoostNestedCVOptions, run_xgboost_outer_task  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run one IGH XGBoost nested-CV outer task.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def main() -> int:
    ...
    try:
        ...
        legacy_static_features = select_static_igh_features(manifest, available_columns=base.columns, require_all_available=True)
        ...
        print("IGH XGBoost nested-CV task: COMPLETE")
        ...
        print(f"IGH XGBoost nested-CV task: FAIL\n{exc}", file=sys.stderr)
        return 1
