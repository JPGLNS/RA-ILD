#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Prepare one isolated RA-ILD IGH analysis scheme from a compact YAML definition."""
...
from ra_ild_igh.scheme_management import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Resolve and prepare an isolated RA-ILD IGH analysis scheme.",
...
def main() -> int:
    ...
    try:
        ...
        print("RA-ILD IGH scheme preparation")
