#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Aggregate completed IGH V2 outer tasks and calculate stability summaries."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Aggregate and summarize IGH V2 repeated nested-CV outer tasks.",
...
def main() -> int:
    ...
    try:
        ...
        print(f"IGH V2 outer aggregation: FAIL\n{exc}", file=sys.stderr)
        return 1
