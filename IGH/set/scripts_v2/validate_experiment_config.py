#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Validate a IGH V2 experiment YAML without running a model."""
...
PATH_SPECS = (
    ...
    ("public_reference.cache.presence", "file"),
    ("public_reference.cache.frequency", "file"),
    ("public_reference.cache.metadata", "file"),
    ("public_reference.regression_task.task_dir", "dir"),
    ("preprocessing.regression_task.task_dir", "dir"),
    ("preprocessing.regression_task.preprocessing_summary", "file"),
    ("preprocessing.regression_task.static_feature_list", "file"),
    ...
    ("nested_cv.regression_task.configuration", "file"),
    ("nested_cv.regression_task.sample_roles", "file"),
    ("nested_cv.regression_task.public_reference_summary", "file"),
    ("nested_cv.regression_task.public_loo_assignments", "file"),
    ...
    ("modeling.regression_task.coefficients", "file"),
    ("modeling.regression_task.independent_predictions", "file"),
    ("modeling.regression_task.independent_metrics", "file"),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate a IGH V2 YAML experiment configuration.",
...
def main() -> int:
    ...
    try:
        ...
        if args.json:
            ...
            print("IGH V2 configuration: PASS")
        ...
        print(f"IGH V2 configuration: FAIL\n{exc}", file=sys.stderr)
        return 1
