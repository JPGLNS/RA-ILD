#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""XGBoost backend utilities for the IGH V2 framework.
...
class XGBoostError(ValueError):
    """Raised when XGBoost inputs/configuration violate the Batch 15 contract."""
...
def fit_xgboost(
    ...
    *,
    ...
    if str(parameters.get("objective", "binary:logistic")) != "binary:logistic":
        raise XGBoostError("Batch 15 requires objective='binary:logistic'")
