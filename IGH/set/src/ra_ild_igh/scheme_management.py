#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Configuration-driven analysis-scheme preparation for the RA-ILD IGH framework.
...
DEFAULT_SCHEME_ROOT = Path("IGH/set/experiments")
...
def build_prepared_scheme(
    ...
    experiment["description"] = description or str(
        experiment.get("description", "RA-ILD IGH analysis scheme")
    )
