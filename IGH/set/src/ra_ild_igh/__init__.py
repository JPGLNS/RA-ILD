"""Reusable components for the RA/RA-ILD IGH V2 framework.
...
specific submodules (for example ``ra_ild_igh.modeling`` and
``ra_ild_igh.metrics``). This keeps configuration and path validation usable
