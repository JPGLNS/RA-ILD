#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Load and validate IGH V2 experiment YAML files."""
...
def validate_experiment_mapping(raw: Mapping[str, Any]) -> None:
    """Validate the current IGH V2 configuration schema."""
    ...
    if _string(experiment, "receptor", "experiment") != "IGH":
        raise ConfigError("experiment.receptor must be IGH")
