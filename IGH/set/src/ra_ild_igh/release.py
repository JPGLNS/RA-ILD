#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Release-validation helpers for the IGH V2 framework.
...
DEFAULT_CONFIG = "IGH/set/configs/igh_baseline_m2_v1.yaml"
...
PRIOR_FULL_NESTED_VALIDATION: Mapping[str, Any] = {
    ...
    "summary": "IGH Batch 01 has not yet executed the full 480-inner-fit V2 regression.",
    "inner_fits": 480,
    "status": "not_yet_executed_for_igh_batch01",
}
...
def _script_command(
    ...
    *extra: str,
    ...
    script = repository_root / "IGH/set/scripts_v2" / script_name
    return (
        python_executable,
        str(script),
        "--config",
